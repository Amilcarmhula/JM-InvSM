 ...
 */
package jminvsm.views.modulo_venda.vendaView.vendasPOS;
 ...
 */
public class VendasPOSController implements Initializable {
...
//            labDataInicial.setText(InvoiceUtilities.actualDate());
            ...
            Logger.getLogger(VendasPOSController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
